    ...
    for(let i = 0; i < curves.length; i ++) {
        ...
        if(!stereoscopy) {
            ...
            for(let j = 0; j < curves[i].points.length-1; j ++) {
                drawLine(parseInt((translated[j].x + 1) * 500, 10), parseInt((translated[j].y + 1) * 350, 10), parseInt((translated[j + 1].x + 1) * 500, 10), parseInt((translated[j + 1].y + 1) *350, 10), ctx);
            }
            ctx.stroke();
        } else {
            ...
            ctxS1.beginPath();
            for(let j = 0; j < curves[i].points.length-1; j ++) {
                drawLine(parseInt((left[j].x + 1) * 500, 10), parseInt((left[j].y + 1) * 350, 10), parseInt((left[j + 1].x + 1) * 500, 10), parseInt((left[j + 1].y + 1) *350, 10), ctxS1);
            }
            ctxS1.stroke();    
            ctxS2.beginPath();
            for(let j = 0; j < curves[i].points.length-1; j ++) {
                drawLine(parseInt((right[j].x + 1) * 500, 10), parseInt((right[j].y + 1) * 350, 10), parseInt((right[j + 1].x + 1) * 500, 10), parseInt((right[j + 1].y + 1) *350, 10), ctxS2);
            }
            ctxS2.stroke();
            stereoscopyDraw();   
        }
